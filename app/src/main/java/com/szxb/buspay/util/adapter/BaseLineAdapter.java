...
public abstract class BaseLineAdapter extends RecyclerView.Adapter<BaseLineAdapter.BaseHolder> {

    private List<LINEGuideEntity> mList;
    ...
    public BaseLineAdapter(Context context, List<LINEGuideEntity> mList, RecyclerView mRecyclerView) {
        this.mList = mList;
    ...
    public void refreshData(List<LINEGuideEntity> list) {
        this.mList = list;
        notifyDataSetChanged();
    }

    public void addData(List<LINEGuideEntity> list) {
    ...
    //得到请求的position的Str
    public LINEGuideEntity getCurrentItemPositionStr() {
    ...
    protected abstract void convert(BaseHolder holder, LINEGuideEntity t, int position);

    public abstract void select(LINEGuideEntity t);
